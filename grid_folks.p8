...
function _draw()
  ...
  draw_score()
	...
	for x = 1, cols do
      ...
      local found_wall_right = false
      local found_wall_down = false
      ...
      if not found_wall_down and y < rows then
        draw_path_down(x_pos, y_pos)
      end
      if not found_wall_right and x < cols then
        draw_path_right(x_pos, y_pos)
      end
		end
	end
...
__gfx__

